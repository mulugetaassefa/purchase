...
// Ensure that 'auth.admin' is registered in Kernel.php before using it
Route::middleware(['auth', AuthAdmin::class])->group(function () {
    ...
    Route::put('/admin/brand/edit/{id}',[AdminController::class,'brand_edit'])->name('admin.brand_edit');
});
